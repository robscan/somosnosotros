...
**Last updated:** 2026-09-13 — **Otro sitio, sitio reservado y lectura del cartel en producción** (PR #8 mergeado; bitácora [009](../bitacora/2026/09/009-otro-sitio-reservado-cartel.md)). Faltan: `ANTHROPIC_API_KEY` del founder para probar el cartel, y la prueba de la Fase 3. Ciudad inicial San Luis Potosí; español; publican admin + usuarios.
