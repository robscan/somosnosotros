...
1. **Cabecera pegajosa de Lugares**: pestañas **Mapa · Lista, con el mapa primero y por defecto** (decisión del founder, v1.1: en Lugares el mapa es la vista natural; en Agenda no), y, en la vista de lista, un chip "Cerca de mí" que pide la ubicación con un botón y con motivo (no se guarda), como en Agenda; con ubicación el chip queda activo y muestra ✕ para quitarla. La búsqueda por nombre aparece a partir de 8 lugares. *Añadido el 2026-09-14 (bitácora 030): una sola fila de chips bajo la búsqueda: Cerca de mí · Todos · Casa de cultura · Foro · Galería · Colectivo · Otro (tipos solo los presentes, a partir de 8); el mismo tipo y la misma búsqueda filtran el mapa, flotando arriba (un resultado: se acerca y abre la tarjeta; varios: se encuadran); pendiente de firma.* *Jakob, Hick, Evidencia.* (F4) **Actualizado 2026-09-19 (OL-087, [prototipo](prototipos/cabeceras.html), firmado por el founder):** la cabecera es la común de Agenda, Lugares y Artistas: ciudad a la izquierda; a la derecha, un botón redondo que enseña la otra vista (Mapa o Lista, el mapa sigue siendo la de entrada) y la lupa; debajo, pestañas Todos · Cercanos · tipos. «Cerca de mí» pasa a ser la pestaña Cercanos, exclusiva con el tipo; en el mapa, Cercanos sustituye al botón redondo de ubicación y centra en el punto azul. Al bajar se esconde el renglón de arriba y vuelve al subir; tras bajar una pantalla aparece ↑.
