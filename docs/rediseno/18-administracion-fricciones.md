# Administración · lista de fricciones e indicadores propuestos (v1: firmada por el founder el 2026-09-16)
...
**Firma del founder (2026-09-16, noche):** «Firmo». De acuerdo con todas las fricciones y con las opciones recomendadas: **D1 = B** (solo las cuentas de origen cambian el rol), **D2 = A** (correo oculto en la lista, completo al tocar "Ver") y **D3 = A** (se guarda solo el último día que se abrió la app).
...
| D1 | Rol | ¿Quién puede hacer y quitar administradores? | Prevención | Decidido | **B:** solo las cuentas de origen (las tuyas) |
| D2 | Personas | ¿El panel muestra el correo de cada persona? | Privacidad · Evidencia | Decidido | **A:** oculto en la lista, completo al tocar "Ver" |
| D3 | Indicadores | ¿Guardamos el último día que alguien abrió la app? | Evidencia · Privacidad | Decidido | **A:** solo el día, solo para administración |
...
**Recomendación:** B.
**Tu decisión:** ☐ A · ☑ B (founder, 2026-09-16)
...
**Recomendación:** A.
**Tu decisión:** ☑ A (founder, 2026-09-16) · ☐ B · ☐ C
...
**Recomendación:** A.
**Tu decisión:** ☑ A (founder, 2026-09-16) · ☐ B
