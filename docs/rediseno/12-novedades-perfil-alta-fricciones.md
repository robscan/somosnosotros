# Novedades, perfil y alta de lugar · lista de fricciones (v1, para corrección del founder)
...
| P1 | Mi perfil | Ajustes (Avisos, Perfil reservado) entre la actividad; el menú ··· mezcla Editar con Cerrar sesión y Borrar | Hick · Progressive disclosure | Alta | Mi perfil = la ficha tal como la ven los demás + Editar. Todo lo de configurar se va a "Ajustes" (engrane en la barra) |
...
| L2 | Alta de lugar | Mapa de 280 px y campo de dirección a la vista desde el principio, aunque el nombre casi siempre los trae | Hick · UX invisible | Alta | "Dónde" como renglón resuelto; el mapa vive en una hoja a toda la pantalla que se abre solo si hace falta |
| L3 | Alta de lugar | El desplegable nativo de tipo aparece antes de saber nada del lugar | Hick · Similitud | Media | "Tipo" como renglón resuelto (deducido del nombre o de Mapbox); chips al abrir |
...
**Propuesta.** Mi perfil es exactamente la ficha que ven los demás, con dos píldoras bajo el nombre: Editar (hoja ya firmada) y Compartir. En la barra, un engrane que lleva a "Ajustes": Avisos · Perfil (público/reservado) · Entras con ro…@ · Invita a tus amigos · (Administración) · Cerrar sesión · Borrar mi cuenta al final y en rojo. El menú ··· desaparece de Mi perfil: no queda nada que esconder ahí. Cuestionado fuerte: ¿hace falta siquiera una pantalla "Mi perfil" distinta de `/personas/[yo]`? Sí, por dos razones: es la única con Editar y con el renglón "Completa tu perfil"; y es a donde lleva el avatar de la barra. Pero debe ser la misma ficha, no otra. *Hick (una decisión por pantalla), Progressive disclosure (configurar es capa c), Jakob (engrane = ajustes).*
**Tu decisión:** ☐ de acuerdo ☐ cambia: ______
