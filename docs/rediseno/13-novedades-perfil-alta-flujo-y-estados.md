...
5. **Mi perfil es la ficha**: Ajustes y Compartir juntos, arriba a la derecha junto al nombre (corrección del founder en el iPhone, v1.3: dos acciones, una región); en la ajena solo Compartir. Lo único distinto de la ajena es el engrane y el aviso de completar. **El resumen en números es la pestaña**: Va a · Sigue (· Van a lo mismo) en una sola línea, la etiqueta y luego el número grande ("Voy a 2 · Sigo 6"), con una raya común abajo y la elegida del color de acción, como los filtros de la agenda (v1.3); tocar uno muestra su lista. En "Sigue", lugares y artistas van en grupos con subtítulo ("Lugares · 4", "Artistas · 2"), como los días de "Va a"; a partir de 12 seguidos, chips "Todo · Lugares · Artistas" con conteo que filtran (misma regla que las listas de Artistas y Lugares). Editar, Avisos, Perfil reservado, Invitar, Cerrar sesión, Borrar y Administración viven en Ajustes; el menú ··· desaparece de Mi perfil. Iconos convencionales con nombre en tooltip y aria-label. *Hick, Progressive disclosure, Jakob, intención.* (P0, S0)
