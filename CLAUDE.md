...
- Git: un PR por fase o pieza grande; commits y push solo cuando el founder lo pida. Bitácora numerada en `docs/bitacora/AAAA/MM/NNN-*.md` por sesión y `OPEN_LOOPS.md` actualizado al cerrar.
