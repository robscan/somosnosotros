...
import { fechaRelativaNovedadArtista, NOVEDADES_ARTISTA_VISIBLES_DE_ENTRADA, type ProveedorNovedadArtista } from "@/lib/novedadesArtista";
import ficha from "@/components/ui/Ficha.module.css";
import canon from "@/components/ui/FormularioCanon.module.css";
import styles from "./SeccionNovedades.module.css";

export type NovedadParaFicha = { id: string; titulo: string | null; texto: string | null; creado_en: string; proveedor: ProveedorNovedadArtista; incrustado: IncrustadoType | null };
