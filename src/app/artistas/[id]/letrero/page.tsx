...
import BarraLetrero from "./BarraLetrero";
 ...
 * pegarlo donde se presenta. Página aparte, sin la cabecera ni la barra de la app raíz (nada que estorbe al
 * imprimir), A4 con `@page` en `letrero.module.css` — se abre desde la hoja de compartir y se imprime sola al
 * cargar (`ImprimirAlAbrir`); "Guardar como PDF" en el cuadro de impresión del navegador entrega el PDF, sin
 * generarlo a mano ni sumar una dependencia nueva. `BarraLetrero` (OL-183) es la única cabecera propia: en el
 * visor de PDF de la app instalada, sin barra del navegador, era la única forma de volver a la ficha.
 */
export default async function LetreroArtista({ params }: Params) {
  ...
  return (
    <>
      <BarraLetrero hrefArtista={hrefArtista(a)} />
      <main className={styles.pagina}>
        ...
        <p className={styles.ayuda}>
          Se imprime sola al abrir. Si no, toca “Imprimir o guardar PDF”. En el iPhone, en el cuadro de impresión,
          elige Compartir y luego Guardar en Archivos. En las opciones, quita encabezados y pies de página.
        </p>
      </main>
    </>
  );
