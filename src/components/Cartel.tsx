...
export default function Cartel({ src, alt }: { src: string; alt: string }) {
  ...
  return (
    <>
      <button type="button" className={styles.banda} onClick={() => setAbierto(true)} aria-label={`Ver ${alt} entero`}>
